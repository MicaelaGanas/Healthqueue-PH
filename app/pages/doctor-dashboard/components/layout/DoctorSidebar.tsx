...
const navItems: { href: string; label: string; icon: string; tabId?: string }[] = [
  { href: "#consultation", label: "Consultation", icon: "stethoscope", tabId: "consultation" },
...
export type DoctorTabId = "consultation" | "settings";
          ...
          if (item.tabId && onTabChange) {
            return (
              <button
                key={item.href}
                type="button"
                onClick={() => onTabChange(item.tabId as DoctorTabId)}
