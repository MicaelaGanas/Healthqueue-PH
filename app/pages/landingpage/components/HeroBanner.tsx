...
export function HeroBanner() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-[#0f172a]/80" aria-hidden />
      <div
        className={`relative mx-auto flex min-h-[280px] max-w-7xl flex-col items-center justify-center px-4 py-12 text-center sm:min-h-[320px] sm:px-6 ${
